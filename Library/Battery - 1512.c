...
void verifybattery(tWord Check2)
	...
	switch(Battery_level)
		...
		case 48:
			...
			else if((Check2 < 0x217)&&(Check2 >= 0x20e))
				{
				voice_EN = 1;
				SC_Speech(8);  
				Delay(100);
			...
			else if((Check2 < 0x20e)&&(Check2 >= 0x206))		
				{
				voice_EN = 1;
				SC_Speech(7);  	
				Delay(100);
			...
			else if((Check2 < 0x206)&&(Check2 >= 0x1fd))		
				{
				voice_EN = 1;
				SC_Speech(6);  	
				Delay(100);
			...
			else if((Check2 < 0x1fd)&&(Check2 >= 0x1f2))		
				{
				voice_EN =1;
				SC_Speech(5);  	
				Delay(100);
		...
		case 60:
			...
			else if((Check2 < 0x29c)&&(Check2 >= 0x28b))		
				{
				voice_EN = 1;
				SC_Speech(9);  
				Delay(100);
			...
			else if((Check2 < 0x28b)&&(Check2 >= 0x277))		
				{
				voice_EN = 1;
				SC_Speech(8);  
				Delay(100);
			...
			else if((Check2 < 0x277)&&(Check2 >= 0x270))		
				{
				voice_EN = 1;
				SC_Speech(7);  	
				Delay(100);
			...
			else if((Check2 < 0x270)&&(Check2 >= 0x268))		
				{
				voice_EN = 1;
				SC_Speech(6);  	
				Delay(100);
			...
			else if((Check2 < 0x268)&&(Check2 >= 0x25f))		
				{
				voice_EN =1;
				SC_Speech(5);  	
				Delay(100);
